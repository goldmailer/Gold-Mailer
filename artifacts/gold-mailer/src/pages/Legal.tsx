  ...
  return (
    <main className="min-h-screen bg-background px-5 py-10 text-foreground">
      <div className="mx-auto max-w-3xl">
        <Link href="/" className="inline-flex items-center gap-2 text-sm font-semibold text-muted-foreground hover:text-foreground"><ArrowLeft size={15} /> Back to Task Nest</Link>
        <article className="mt-8 rounded-3xl border border-border bg-card p-6 shadow-xl shadow-black/10 sm:p-10">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-primary">Task Nest</p>
