    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #fff; padding: 40px; border-radius: 12px;">
        ...
        <div style="background: #1a1a1a; border: 1px solid #f5c518; border-radius: 8px; padding: 24px; text-align: center; margin: 24px 0;">
          <span style="font-size: 36px; font-weight: bold; color: #f5c518; letter-spacing: 8px;">${safeCode}</span>
        </div>
        <p style="color: #888; font-size: 14px;">This code was sent to ${safeEmail}. It expires in <strong style="color: #f5c518;">20 minutes</strong>. Do not share it with anyone.</p>
  ...
  const { error } = await resend.emails.send({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #fff; padding: 40px; border-radius: 12px;">
        ...
        <p style="color: #bbb; line-height: 1.6;">We received a request to reset the Gold Mailer password for ${safeEmail}. Use the code below:</p>
        <div style="background: #1a1a1a; border: 1px solid #f5c518; border-radius: 8px; padding: 24px; text-align: center; margin: 24px 0;">
          <span style="font-size: 36px; font-weight: bold; color: #f5c518; letter-spacing: 8px;">${safeCode}</span>
        </div>
